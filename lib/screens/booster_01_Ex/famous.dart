              ...
              Expanded(
                child:  ListView(
                  children:  [
                    ...
                    const Divider(),
                    const ListTile(
                      title: Text('ඇය මුදල් අපහරණයට ප්‍රසිද්ධයි.',style: TextStyle(color: Colors.black,fontSize: 16.0,fontWeight: FontWeight.w700),),
                      subtitle: Text('She is famous foe stealing money.',style: TextStyle(color: Colors.blueGrey,fontSize: 18.0,fontWeight: FontWeight.w700),),
                    ),
                    const Divider(),
